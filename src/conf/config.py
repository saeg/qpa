...
SKIP_DIRS_COMMON = [
    ...
    '.mypy_cache', 'benchmarks', 'jupyter_execute', '_build',
    'jupyter_notebooks', 'scripts', 'tools', 'dev_tools', 'binder',
    '.github', '.pytest_cache', '.ipynb_checkpoints', 'htmlcov',
    'test_data', 'utils', 'tests', 'test'
]
